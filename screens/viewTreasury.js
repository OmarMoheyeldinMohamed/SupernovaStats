                ...
                {selectedTreasuryName !== "" && amount != 0 && (
                  <View>
                    <View style={{ width: "100%", flexDirection: "row" }}>
                      ...
                      {/* Supernova Colors */}
                      <Switch
                        trackColor={{ false: "#767577", true: "#74659d" }}
                        thumbColor={allPlayersSwitch ? "#513e85" : "#f4f3f4"}
                    ...
                    {allPlayersSwitch === false && (
                      <Table
                        borderStyle={{ borderWidth: 2, borderColor: "#bdbaf6" }}
                      >
                        <Row
                          data={tableHead}
                          style={styles.head}
...
const styles = StyleSheet.create({
  row: { flexDirection: "row", backgroundColor: "#e8e7fc" },
  ...
  head: { height: 40, backgroundColor: "#bdbaf6" },
  text: { margin: 6 },
  lottie: {
    width: 100,
    height: 100,
