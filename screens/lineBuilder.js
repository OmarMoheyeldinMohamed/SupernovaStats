      ...
      <ScrollView>
        ...
        <View style={{ width: "100%" }}>
          ...
          <View style={{ width: "100%", padding: 15 }}>
            <Table borderStyle={{ borderWidth: 2, borderColor: "#B19CD8" }}>
              <Row
...
const styles = StyleSheet.create({
  ...
  head: { height: 40, backgroundColor: "#CBC3E3" },
  wrapper: { flexDirection: "row" },
  title: { flex: 1, backgroundColor: "#CBC3E3" },
  title2: { flex: 0.5, backgroundColor: "#CBC3E3" },
